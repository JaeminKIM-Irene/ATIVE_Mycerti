...
(function (global, factory) {
  ...
  var DAYS_OF_WEEK = ['일요일', '월요일', '화요일', '수요일', '목요일', '금요일', '토요일'];
  var DAYS_OF_WEEK02 = ['S', 'M', 'T', 'W', 'T', 'F', 'S'];
  /**
  ...
  var WEEK_DAYS_HTML = "<span>".concat(DAYS_OF_WEEK02.map(function (x) {
    return x.substr(0, 1);
  }).join('</span><span>'), "</span>");
  /**
  ...
  var _duDatePicker = /*#__PURE__*/function () {
    ...
    _createClass(_duDatePicker, [{
      ...
      value: function _setSelection() {
        ...
        picker.header.selectedYear.innerText = selected.getFullYear() + "년";
